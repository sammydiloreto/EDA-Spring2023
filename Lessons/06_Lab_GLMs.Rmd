...
PM25byO3.regression <- lm(data = EPAair, PM2.5 ~ Ozone)
summary(PM25byO3.regression)
...
Ozone.ALL <- lm(data = EPAair.subset, PM2.5 ~ mean_Lat + mean_Lng + 
              Month + Year + Ozone)
summary(Ozone.ALL)
step(Ozone.ALL)

Ozone.Best <- lm(data = EPAair.subset, PM2.5 ~ mean_Lat + mean_Lng + 
              Month + Ozone)
summary(Ozone.ALL)
