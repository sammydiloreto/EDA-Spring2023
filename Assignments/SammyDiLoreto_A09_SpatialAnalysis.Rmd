...
ggplot() + 
  geom_sf(data=NE_counties_sf, fill = "lightyellow") + 
  geom_sf(data=NWIS_gage_sf, color = "mediumblue")+
...
NWIS_gage_sf_join = merge(x = NWIS_gage_sf,
                     ...
                     by.x = 'site_no',
                     by.y = 'site_no')
                     #???result only includes spatial features where both tables have data
...
ggplot() +
  geom_sf(data=NE_counties_sf, fill = "lightyellow") +
  geom_sf(data = NWIS_gage_sf_join, aes(fill= gage_ht_mean)+
  labs(
...
#21 Plot the data
ggplot() +
  geom_sf(data=NE_counties_sf_utm, fill = "lightyellow")+
  geom_sf(data = NWIS_gage_sf_utm, color = "blue")
...
#24 Plot
ggplot()+
  geom_sf(data = douglas_sf, fill="lightgreen")+
  geom_sf(data = douglas_gages, color="purple")
