...
ggplot() +
  ...
  geom_sf(data = NWIS_gage_sf_join, aes(color= gage_ht_mean), size= 3)+
...
mapview(NE_counties_sf_utm, col.regions = 'lightgreen', 
        layer.name = "Nebraska Counties") + 
  mapview(douglas_sf, col.regions= "orange",
          layer.name = "Douglas County, NE")+
  mapview(douglas_gages, col.regions= "purple", 
          alpha.regions = 1,
          layer.name= "Douglas County Gage Sites")
