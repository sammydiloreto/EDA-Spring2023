...
> Answer: I've taken Geospatial Data Analytics (ENV 859) where we used Python and Git for preparing and running geospatial analyses. I used in R for statistical analyses in ENV 710, ENV 537, and for a summer research project. 

2. Are there any components of the course about which you feel confident?

> Answer: I feel confident navigating R studio and git and coding in general because of my experience in ENV 859 with python.

3. Are there any components of the course about which you feel apprehensive?

> Answer: The terminology will be something to get used to. I'm a little worried about using my own computer because if I do run into any issues, it may be difficult for the the instructors to fix. 
